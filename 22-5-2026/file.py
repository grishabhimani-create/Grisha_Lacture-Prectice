...
# During Object creation / During Object destruction
...
# Encapsulation = Data Protection + Contolled Access
...
# Inheritance allows one class to acquire the properties and method of another class
...
# Single inheritance means one child class inherits from on parent class.
